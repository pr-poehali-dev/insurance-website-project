...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Получение компенсации в случае наступления страхового события",
      icon: "Heart",
      calculatorType: "life",
      features: ["Семейные программы", "Быстрые выплаты", "Налоговые льготы"]
    },
    {
    ...
    },
    {
      ...
      icon: "Stethoscope",
      calculatorType: "dms",
      features: ["Лучшие клиники", "Вызов врача на дом", "Онлайн-консультации", "Комплексные обследования"]
    },
    {
      title: "НС",
                ...
                <div className="flex items-start justify-center mb-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-amber-700 leading-relaxed">
                      ...
                      Предоставлю несколько вариантов в нашей страховой компании.
                    </p>
                  </div>
                </div>
              </div>
